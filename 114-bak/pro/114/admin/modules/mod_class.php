 ...
 */
    ...
    public static function add_class( $data = array() )
    {
        ...
        else
        {
            ...
            else
            {
                ...
                app_db::query("INSERT INTO ylmf_class (parentid,classname,displayorder,path,keywords,description)VALUES ('$classid','$classnewname','$orderid','$path','$keywords','$description')");

                $class_list = self::get_class_list();
                if(app_db::insert_id() !== 0)
                {
                    $new_class_id = app_db::insert_id();
                    $class_list[$new_class_id] = array('classid' => $new_class_id, 'parentid' => $classid, 'classname' => $classnewname, 'displayorder' => $orderid,  'sitenum' => '0', 'path' => $path, 'keywords' => $keywords, 'description' => $description);
                }
    ...
    public static function edit_class($data)
    {
        ...
        else
        {
            ...
            app_db::query("UPDATE ylmf_class SET classname='$classnewname' ,parentid='$classid',path='$path', keywords='$keywords',description='$description'  WHERE classid='$id'");
