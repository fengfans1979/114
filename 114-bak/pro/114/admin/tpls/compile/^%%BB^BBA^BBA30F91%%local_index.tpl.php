...
<a  href="chongqin.htm" title="重庆" target="_parent">重庆</a>
...
/static/images/chinamap.gif" border="0" usemap="#Map" alt="地图"  width="737" height="581" />
        <map name="Map" id="Map">
...
<area shape="rect" coords="607,148,641,169" href="jilin.htm" alt="吉林" />
    ...
    <h3>综合地方门户</h2>
    <ul>
        <?php $_from = $this->_tpl_vars['local_index_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
