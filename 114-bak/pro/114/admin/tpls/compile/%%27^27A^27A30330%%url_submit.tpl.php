<?php /* Smarty version 2.6.25, created on 2010-08-02 15:13:00
         compiled from url_submit.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'url_submit.tpl', 4, false),)), $this); ?>
...
" />
<title>网站提交 ->  网站收录提交入口 -<?php echo $this->_tpl_vars['sysname']; ?>
</title>
<style>
<!--
body { background:#3C7FAF url(<?php echo $this->_tpl_vars['URL']; ?>
/satatic/images/bd_bg.png) repeat-x top; margin:0; font:12px Verdana; color:#07519A; }
...
#footer .link { width:510px; line-height:22px; margin:auto; background:url(<?php echo $this->_tpl_vars['URL']; ?>
/static/images/sitem_bg.gif) repeat-x bottom; }
#footer .hr {
...
<div id="header">
  <div id="elogin">
    <div class="r"><a href="#" onclick="javascript:this.style.behavior='url(#default#homepage)';this.setHomePage('<?php echo $this->_tpl_vars['URL']; ?>
');">设为首页</a> | <a href="javascript:addBookmark('<?php echo $this->_tpl_vars['sysname']; ?>
','<?php echo $this->_tpl_vars['URL']; ?>
');">加入收藏</a></div>
      <a href="<?php echo $this->_tpl_vars['URL']; ?>
" target="_blank"><<返回首页</a>　 <a href="http://fav.115.com" >网络收藏夹</a>
    <label></label>
  </div>
  <div id="banner">
    <div id="money">
    ...
    <div id="logo"><a href="<?php echo $this->_tpl_vars['URL']; ?>
/" target="_top"><img src="<?php echo $this->_tpl_vars['URL']; ?>
/static/images/logo.gif" alt="LOGO"/></a></div>
  </div>
</div>
<div class="con">
    <h3>如果您希望<a href="<?php echo $this->_tpl_vars['URL']; ?>
" target="_blank"><?php echo $this->_tpl_vars['sysname']; ?>
</a> 收录您的网站，贵站需要满足以下条件（即收录原则）： </h3>
    <p>1. 不收录有反动、色情、赌博等不良内容或提供不良内容链接的网站，以及网站名称或内容违反国家有关政策法规的网站；<br />
      ...
      4. 不收录以同类型网站通用名称文字作为申请的名称，例如“在线音乐”，请以适当的网站名做为申请名称，如xiazaiba.com的网站中文名是“<a href=http://www.xiazaiba.com/" target="_blank">绿色下载吧</a>”； <br />
...
&nbsp;&nbsp;&nbsp;&nbsp; 一些购物类网站等盈利性站点，请直接联系本站客服进行广告服务咨询。我们将为您提供最佳广告位！
  ...
  <?php if ($this->_tpl_vars['message']): ?><h2 style="color: blue;"><?php echo $this->_tpl_vars['message']; ?>
</h2><?php endif; ?>
  <form action="<?php echo $this->_tpl_vars['URL']; ?>
/url-submit/" method="post" onSubmit="return Validator.Validate(this,3)" name='siteadd' id="siteadd">
  ...
  <tr>
    <th>首页地址：</th>
    <td><input name="input" type="text" onclick="copyToClipBoard(this.value)" value="<?php echo $this->_tpl_vars['URL']; ?>
" class="urltxt" /></td>
  </tr>
  <tr>
    <th>图片链接：</th>
    <td><img src="<?php echo $this->_tpl_vars['URL']; ?>
/static/images/8831-logo.gif" alt="<?php echo $this->_tpl_vars['sysname']; ?>
" width="88" height="31" /></td>
  </tr>

  <tr>
    <th>首页地址：</th>
    <td><input name="input1" type="text" class="urltxt" id="input1" onclick="copyToClipBoard(this.value)" value="<?php echo $this->_tpl_vars['URL']; ?>
" /></td>
  </tr>
  <tr>
    <th>Logo地址：</th>
    <td><input name="input2" type="text" class="urltxt" id="input2" onclick="copyToClipBoard(this.value)" value="<?php echo $this->_tpl_vars['URL']; ?>
/logo.gif" /></td>
  </tr>

  <tr>
    <th>网站简介：</th>
    <td><?php echo $this->_tpl_vars['sysname']; ?>
</td>
  </tr>
</table>
  </div>
...
/feedback" target="_blank">意见反馈</a> | <a href="http://www.114la.com/gongyihuodong/index.htm" target="_blank">公益活动</a> 
            <div class="hr"></div>
           Powered by <a href="http://www.114la.com/">114啦网址导航</a>&copy;2005-2009 . All Rights Reserved.
        </div>
        <!--/ footer-->
<div style="display:none">
<?php echo $this->_tpl_vars['tongji']; ?>
