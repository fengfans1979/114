<?php /* Smarty version 2.6.25, created on 2010-08-06 12:24:50
         compiled from famous_loop_list.tpl */ ?>
...
<div class="wrap">
    <div class="container">
        ...
        <div id="main">
            ...
            <div class="con">
            	<form action="?c=famous_loop&a=list_edit" method="post">
                    <input type="hidden" name="referer" value="<?php echo $this->_tpl_vars['referer']; ?>
"/>
                  <div class="table">
                  	<div class="th">
                    	<div class="form fl">
                        <input type="button" value="添加站点" onclick="window.location='?c=famous_loop&a=edit&action=add'"/>&nbsp;
                        </div>
                    </div>
...
" /></td>                 
                        <td><a href="?c=famous_loop&a=edit&action=modify&id=<?php echo $this->_tpl_vars['k']; ?>
