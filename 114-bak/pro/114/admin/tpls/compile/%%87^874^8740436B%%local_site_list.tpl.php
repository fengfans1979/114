<?php /* Smarty version 2.6.25, created on 2010-08-06 12:37:43
         compiled from local_site_list.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'local_site_list.tpl', 58, false),)), $this); ?>
...
<div class="wrap">
    <div class="container">
        ...
        <div id="main">
            ...
            <div class="con">
            	<form action="?c=local_site&a=search" method="get">
                    <input type="hidden" name="c" value="local_site"/>
...
" id="keyword" name="keyword"/>
            	...
            	<form action="?c=local_site&a=list_edit" method="post">
                    <input type="hidden" name="referer" value="<?php echo $this->_tpl_vars['referer']; ?>
"/>
                  <div class="table">
                  	<div class="th">
                    	<div class="form fl">
                        <input type="button" value="添加网址" onclick="self.location='?c=local_site&a=edit&action=add&classid=<?php echo $this->_tpl_vars['class_id']; ?>
'"/>&nbsp;
                        <label for="alltopic"><a href='?c=local_class'>选择分类</a></label>&nbsp;
                        &nbsp;&nbsp;<a href='?c=local_site'>查看所有分类</a></label>&nbsp;
                        &nbsp;&nbsp;<a href="?c=local_site&isend=1">查看过期站点</a>&nbsp;
                        </div>                        
...
" /></td>                 
                        <td><a href="?c=local_site&a=edit&action=modify&id=<?php echo $this->_tpl_vars['i']['id']; ?>
"><?php echo $this->_tpl_vars['i']['name']; ?>
</a></td>
                        <td><div style="width:280px" class="hideText" title="<?php echo $this->_tpl_vars['i']['url']; ?>
"><?php echo $this->_tpl_vars['i']['url']; ?>
</div></td>
                        <td><a href="?c=local_site&classid=<?php echo $this->_tpl_vars['i']['class_id']; ?>
