<?php /* Smarty version 2.6.25, created on 2010-08-06 12:37:39
         compiled from local_index_list.tpl */ ?>
...
<div class="wrap">
    <div class="container">
        ...
        <div id="main">
            ...
            <div class="con">
            	<form action="?c=local_index&a=list_edit" method="post">
                    <input type="hidden" name="referer" value="<?php echo $this->_tpl_vars['referer']; ?>
"/>
                  <div class="table">
                  	<div class="th">
                    	<div class="form fl">
                        <input type="button" value="添加站点" onclick="window.location='?c=local_index&a=edit&action=add'"/>&nbsp;
                        </div>
                    </div>
...
" /></td>                 
                        <td><a href="?c=local_index&a=edit&action=modify&id=<?php echo $this->_tpl_vars['k']; ?>
