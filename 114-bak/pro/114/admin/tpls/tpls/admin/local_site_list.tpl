            ...
            <div class="con">
            	...
            	<form action="?c=local_site&a=list_edit" method="post">
                  ...
                  <div class="table">
                  	<div class="th">
                    	<div class="form fl">
                        <input type="button" value="添加网址" onclick="self.location='?c=local_site&a=edit&action=add&classid=<{$class_id}>'"/>&nbsp;
                    ...
                    <tr>
                        ...
                        <td><a href="?c=local_site&a=edit&action=modify&id=<{$i.id}>"><{$i.name}></a></td>
                        <td><div style="width:280px" class="hideText" title="<{$i.url}>"><{$i.url}></div></td>
                        <td><a href="?c=local_site&classid=<{$i.class_id}>"><{$i.class_name}></a></td>
