    ...
    <div class="container">
        <div id="main">
            <div class="con box-green">
                <form action="?c=local_site&a=save" method="post">
                    ...
                    <table class="table-font">
                        ...
                        <tr>
                            ...
                            <td>                               
                                ...
                                <div id="cate" style="height:30px; line-height:30px;"><span id="js_link_text_span"></span></div>
                                <div id="cate_list">
                                    <table>
                                        <tr id="js_cate_list">
                                            <td index="0">
                                ...
                                <script type="text/javascript">
									CateListManager.AjaxUrl = "?c=local_class&a=ajax_get_list&id=";
                ...
                <div class="box-footer">
                    <div class="box-footer-inner">
                    	<input type="submit" value="提交" /></a> 或 <a href="?c=local_site&a=index&classid=<{$class_id}>">取消</a>
                    </div>
                </div>
                </form>
            </div><!--/ con-->
