...
<title><{$title}></title>
<link href="themes/custom/base.css" rel="stylesheet" type="text/css" />
<link id="skin" href="themes/custom/skins/blue/style.css" rel="stylesheet" type="text/css" />
<link id="font" href="" type="text/css" rel="stylesheet" />
<script type="text/javascript" src="themes/custom/js/ylmf.cai.js"></script>
<script type="text/javascript" src="themes/custom/js/config.js"></script>
<script type="text/javascript" src="themes/custom/js/base.js"></script>
<base target="_blank" />
</head>
<body>
<div id="home">
<script type="text/javascript" src="themes/custom/js/skin.js"></script>
    <div class="wrap">
    ...
    <div id="top" class="bd">
        ...
        <div id="header" class="clearfix">
            ...
            <h1 id="logo"><a href="<{$URL}>" target="_parent"><img src="static/images/logo.gif" height="69" width="117" /></a></h1>
            <div id="mailBox">
